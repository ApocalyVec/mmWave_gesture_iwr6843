...
#                                                                 #
###################################################################
# ApocalyVec adapted from https://stackoverflow.com/questions/36665850/matplotlib-animation-inside-your-own-gui
...
class CustomMainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Simulated Heatmap")
...
class CustomFigCanvas(FigureCanvas, TimedAnimation):
    ...
    def new_frame_seq(self):
        return iter(range(self.hm_shape[0] * self.hm_shape[1]))
...
def dataSendLoop(addData_callbackFunc):
    ...
    while(True):
        ...
        #     i = 0
        time.sleep(0.1)
        mySrc.data_signal.emit(hm)  # <- Here you emit a signal!
        # i += 1
